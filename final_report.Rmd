...
author: "Maryam Khalid (mk4992), Sijda Ahmed (sa4007), Ruicheng Yang (ry2539), Xiling Wang (xw3107), Haixin Jin (hj2735)"
date: "Fall 2025"
output:
  html_document:
    code_folding: hide
...
- **visualization.html** — exploratory graphics, statistical analysis, and predictive modeling
- **results.html** — full statistical results  
