...
# Load raw dataset
# Starting number of rows is 1884
...
# Recode age bands → ordinal numeric levels
age_levels = c(
  "18-24" = 1,
  "25-34" = 2,
  "35-44" = 3,
...
# Remove individuals who responded with anything other than 0 (never used) to the fictitious drug (Semeron) which was introduced to identify over-claimers
# Now the number of rows is 1876
cleaned <- cleaned |>
  filter(Semer == 0)
