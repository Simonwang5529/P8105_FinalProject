...
ggsave("figs/hist_ocean.png", OCEAN_hist, width = 9, height = 7)
...
ggsave("figs/hist_impulsivity.png", impulsivity_hist, width = 5, height = 7)
...
ggsave("figs/hist_impSS.png", SS_hist, width = 5, height = 7)
